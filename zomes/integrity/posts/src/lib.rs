    ...
    match op.flattened::<EntryTypes, LinkTypes>()? {
        FlatOp::StoreEntry(store_entry) => match store_entry {
            OpEntry::CreateEntry { app_entry, action } => match app_entry {
                ...
                EntryTypes::Like(like) => {
                    validate_create_like(EntryCreationAction::Create(action), like)
                }
                EntryTypes::Certificate(certificate) => {
                    validate_create_certificate(EntryCreationAction::Create(action), certificate)
                }
            },
            OpEntry::UpdateEntry {
                app_entry, action, ..
                ...
                EntryTypes::Like(like) => {
                    validate_create_like(EntryCreationAction::Update(action), like)
                }
                EntryTypes::Certificate(certificate) => {
                    validate_create_certificate(EntryCreationAction::Update(action), certificate)
                }
            },
        ...
        FlatOp::RegisterCreateLink {
            ...
            LinkTypes::LikeToLikes => {
                validate_create_link_like_to_likes(action, base_address, target_address, tag)
            }
            LinkTypes::PostToCertificates => {
                validate_create_link_post_to_certificates(action, base_address, target_address, tag)
            }
            LinkTypes::CertifiedToCertificates => validate_create_link_certified_to_certificates(
                action,
                base_address,
                target_address,
                tag,
            ...
            LinkTypes::PostsByAuthor => {
                validate_create_link_posts_by_author(action, base_address, target_address, tag)
            }
            LinkTypes::AllPostsEntryHash => {
                validate_create_link_all_posts_entry_hash(action, base_address, target_address, tag)
            }
            LinkTypes::PostsByAuthorEntryHash => validate_create_link_posts_by_author_entry_hash(
                action,
                base_address,
                target_address,
                tag,
        ...
        FlatOp::RegisterDeleteLink {
            ...
            LinkTypes::LikeToLikes => validate_delete_link_like_to_likes(
                action,
                original_action,
                base_address,
                target_address,
            ...
            LinkTypes::PostToCertificates => validate_delete_link_post_to_certificates(
                action,
                original_action,
                base_address,
                target_address,
            ...
            LinkTypes::CertifiedToCertificates => validate_delete_link_certified_to_certificates(
                action,
                original_action,
                base_address,
                target_address,
            ...
            LinkTypes::PostsByAuthor => validate_delete_link_posts_by_author(
                action,
                original_action,
                base_address,
                target_address,
            ...
            LinkTypes::AllPostsEntryHash => validate_delete_link_all_posts_entry_hash(
                action,
                original_action,
                base_address,
                target_address,
            ...
            LinkTypes::PostsByAuthorEntryHash => validate_delete_link_posts_by_author_entry_hash(
                action,
                original_action,
                base_address,
                target_address,
                ...
                match app_entry {
                    ...
                    EntryTypes::Like(like) => {
                        ...
                        if let ValidateCallbackResult::Valid = result {
                            ...
                            validate_update_like(action, like, original_action, original_like)
                        } else {
                            Ok(result)
                        }
                    }
            ...
            OpRecord::DeleteEntry {
                ...
                match original_app_entry {
                    ...
                    EntryTypes::Certificate(original_certificate) => {
                        validate_delete_certificate(action, original_action, original_certificate)
                    }
                }
            }
            OpRecord::CreateLink {
                ...
                LinkTypes::PostToCertificates => validate_create_link_post_to_certificates(
                    action,
                    base_address,
                    target_address,
                    tag,
                ...
                LinkTypes::AllPostsEntryHash => validate_create_link_all_posts_entry_hash(
                    action,
                    base_address,
                    target_address,
                    tag,
